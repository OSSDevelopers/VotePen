<template>
    <section id="moderator-panel-rules">
        ...
        <p>
            If your channel needs more rules than already written in VotePen's general <a href="/tos">TOS</a>
            page, you may specify yours here.
            To keep VotePen simple, we allow a maximum number of fine rules per channel. Markdown syntax is allowed.
        </p>
